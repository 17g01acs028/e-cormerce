...
?>
	...
	<div class="container-fluid">
				<!-- row -->
					...
					<div class="login-marg" style="background:black;width:100%">
						<!-- Billing Details -->
						...
						<!-- /Billing Details -->
								...
								<form onsubmit="return false" id="login" class="login100-form " style="background:black;">
									<div class="billing-details jumbotron" style="background: #333333;width:100%;color:brown;">
