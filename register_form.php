    ...
    .input-borders{
        border-radius:30px;
                ...
                <div class="container-fluid" style="background: #333333;width:100%;color:white;">
						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
									<div class="billing-details jumbotron" style="background: #333333;width:100%;color:white;">
